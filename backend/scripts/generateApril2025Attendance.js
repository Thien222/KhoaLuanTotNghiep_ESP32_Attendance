/**
 * Generate Full Month Attendance for April 2025
 * Run with: node scripts/generateApril2025Attendance.js
 */
...
async function main() {
    try {
        ...
        console.log(`📅 Working days in April ${YEAR}: ${workingDays.length}\n`);
